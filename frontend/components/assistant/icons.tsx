...
export function BotIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v1.244m4.5 0V3.104M12 3v1.244M3 13.5A7.5 7.5 0 0010.5 21h3A7.5 7.5 0 0021 13.5V11A7.5 7.5 0 0013.5 3.5h-3A7.5 7.5 0 003 11v2.5z" />
...
export function WrenchIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75a4.5 4.5 0 01-4.884 4.484c-1.076-.091-2.264.071-2.95.904l-7.152 8.684a2.54 2.54 0 01-3.58 0l-.165-.165a2.54 2.54 0 010-3.58l8.684-7.152c.833-.686.995-1.874.904-2.95a4.5 4.5 0 016.32-4.908l-2.477 2.477a1.5 1.5 0 002.122 2.122l2.477-2.477c.361.644.57 1.385.57 2.167z" />
    </svg>
  );
}
